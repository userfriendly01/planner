...
export const RoutingAttributes = (): JSX.Element => {
  ...
  return (
    <Accordion
      ...
      <AccordionDetails>
        <AutoCompleteContainer type={userFormActions.SET_BACK_UP_WORKER} updateOnChange={userFormActions.RESET_BACK_UP_WORKER_FLAG} field='backup_workers' label='Backup Workers' routingAttribute='backupWorkerRouting'   />
      </AccordionDetails>
    </Accordion>
  );
};