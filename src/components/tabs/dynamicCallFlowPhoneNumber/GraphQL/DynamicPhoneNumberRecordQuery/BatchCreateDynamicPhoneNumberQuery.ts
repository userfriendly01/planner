...
export class BatchCreateDynamicPhoneNumberQuery extends AbstractBatchQuery {
...
const batchCreatePhoneNumberQuery = new BatchCreateDynamicPhoneNumberQuery();
 ...
 */
export const batchCreateDynamicPhoneNumberRecord: BatchRecordQuery<PhoneNumber> = async (accessToken: string, phoneNumberRecords: Array<PhoneNumber>): Promise<BatchResults<PhoneNumber>> => {
  return await batchCreatePhoneNumberQuery.runBatch<PhoneNumber>(accessToken, phoneNumberRecords);
};
 ...
 * @return {Promise<BatchResults<PhoneNumber>>}
 */
export const batchUpdateDynamicPhoneNumberRecord: BatchRecordQuery<PhoneNumber> = async (accessToken: string, phoneNumberRecords: Array<PhoneNumber>): Promise<BatchResults<PhoneNumber>> => {
  return await batchCreatePhoneNumberQuery.runBatch<PhoneNumber>(accessToken, phoneNumberRecords);
};