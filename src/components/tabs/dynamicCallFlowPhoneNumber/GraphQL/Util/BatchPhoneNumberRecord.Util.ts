...
import { batchCreateLegacyPhoneNumberRecord } from "../LegacyPhoneNumberRecordQuery/BatchCreateLegacyPhoneNumberRecordQuery";
import {
  BatchRecordQuery, BatchResults
} from "../../../../../common/GraphQL/AbstractBatchQuery";
import { batchUpdateLegacyPhoneNumberRecord } from "../LegacyPhoneNumberRecordQuery/BatchUpdateLegacyPhoneNumberRecordQuery";
import {
  batchCreateDynamicPhoneNumberRecord,
  batchUpdateDynamicPhoneNumberRecord
} from "../DynamicPhoneNumberRecordQuery/BatchCreateDynamicPhoneNumberQuery";
import { PhoneNumberRecordUtil } from "./PhoneNumberRecordUtil";
import { batchDeleteLegacyPhoneNumberRecord } from "../LegacyPhoneNumberRecordQuery/BatchDeleteLegacyPhoneNumberRecordQuery";
...
export class BatchPhoneNumberRecord {
  static async create(accessToken: string, phoneNumberRecords: Array<PhoneNumberRecordType>): Promise<BatchResults<PhoneNumberRecordType>> {
    return await batchPhoneNumberRecords(accessToken, phoneNumberRecords, batchCreateLegacyPhoneNumberRecord, batchCreateDynamicPhoneNumberRecord);
  }
  ...
  static async update(accessToken: string, phoneNumberRecords: Array<PhoneNumberRecordType>): Promise<BatchResults<PhoneNumberRecordType>> {
    return await batchPhoneNumberRecords(accessToken, phoneNumberRecords, batchUpdateLegacyPhoneNumberRecord, batchUpdateDynamicPhoneNumberRecord);
  }
  ...
  static async delete(accessToken: string, phoneNumberRecords: Array<PhoneNumberRecordType>): Promise<BatchResults<PhoneNumberRecordType>> {
    return await batchPhoneNumberRecords(accessToken, phoneNumberRecords, batchDeleteLegacyPhoneNumberRecord, batchDeleteLegacyPhoneNumberRecord);
  }
}