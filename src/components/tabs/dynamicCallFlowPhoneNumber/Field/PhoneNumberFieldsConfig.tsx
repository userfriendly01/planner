...
import {
  ControlEnum,
  DynamicFieldConditionCheckType, FieldType, FieldTypeEnum,
  FormFieldConfig, FormFieldConfigs
 ...
 *
 */
function createPhoneNumberFormFieldConfig(label: string, key: string, control: Control, required: boolean, disableEdit: boolean, dynamicFieldConditionCheck?: DynamicFieldConditionCheckType, fieldType?: FieldType, gridSize?: number): void {
  if (required) {
...
createPhoneNumberFormFieldConfig("Data Requests", DATA_REQUESTS, ControlEnum.AutoComplete, true, false, undefined, FieldTypeEnum.VIEW_AND_ADD, 10);
createPhoneNumberFormFieldConfig("Caller Type", CALLER_TYPE, ControlEnum.AutoComplete, true, false, undefined, FieldTypeEnum.VIEW_AND_ADD, 10);
...
createPhoneNumberFormFieldConfig("Call Flow Route", CALL_FLOW_ROUTE, ControlEnum.AutoComplete, true, false, undefined, FieldTypeEnum.VIEW_AND_ADD, 10);
