...
export const CommonPhoneNumberFields: Array<string> = [
  BRAND,
  CALL_FLOW_TEMPLATE,
  CALL_FLOW_ROUTE,
  CALL_INTENT,
...
Object.freeze(CommonPhoneNumberFields);

export const UniqueDynamicPhoneNumberFields: Array<string> = [
  CALL_FLOW_NAME,
  CALL_FLOW_TYPE,
  NEXT_ACTION_ID,
  NEXT_ACTION_TYPE,
...
Object.freeze(UniqueDynamicPhoneNumberFields);

export const DynamicPhoneNumberFields: Array<string> = UniqueDynamicPhoneNumberFields.concat(CommonPhoneNumberFields);
Object.freeze(DynamicPhoneNumberFields);
