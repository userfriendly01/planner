...
jest.mock("utils/calabrioUtils", () => ({
  ...
  daysOfTheWeekOptions: jest.requireActual("utils/calabrioUtils").daysOfTheWeekOptions,
...
describe("<WfmForm />", () => {
  ...
  describe("Optional Columns", () => {
    ...
    test("updateValue adds to optionalColumns", async () => {
      ...
      const optionalColumnFields = TextField.mock.calls.filter(m => m[0]?.label === `${columnOption.Name} value *`);
      const optionalColumnField = optionalColumnFields[optionalColumnFields.length - 1][0];
    ...
    test("Adding a column does not delete the value in other columns", async () => {
      ...
      const optionalColumn2Fields = TextField.mock.calls.filter(m => m[0]?.label === `${columnOption2.Name} value *`);
      const optionalColumn2Field = optionalColumn2Fields[optionalColumn2Fields.length - 1][0];
      ...
      const optionalColumn1Fields = TextField.mock.calls.filter(m => m[0]?.label === `${columnOption1.Name} value *`);
      const optionalColumn1Field = optionalColumn1Fields[optionalColumn1Fields.length - 1][0];
