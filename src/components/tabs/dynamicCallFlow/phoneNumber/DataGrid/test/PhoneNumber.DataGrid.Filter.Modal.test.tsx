...
const DataGridFilterModalElement: ReactElement = <div data-testid={PhoneNumberDataGridFilterModalDataTestId}><PhoneNumberDataGridFilterModal
  isOpen={true}
...
describe("PhoneNumber.DataGrid.Filter.Modal.Component", () => {
  ...
  describe("initial load", () => {
    ...
    it("should set the filter state to the filter returned from the instance of PhoneNumberDataGridFilter", async () => {
      await waitForElementToRender(DataGridFilterModalElement, PhoneNumberDataGridFilterModalDataTestId);
