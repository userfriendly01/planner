...
class DynamicPhoneNumberListRecordsQuery extends AbstractListRecordsQuery {
...
const dynamicPhoneNumberListRecordsQuery = new DynamicPhoneNumberListRecordsQuery();
