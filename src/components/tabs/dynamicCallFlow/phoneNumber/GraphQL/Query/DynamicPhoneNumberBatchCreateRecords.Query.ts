...
export class DynamicPhoneNumberBatchCreateRecordsQuery extends AbstractBatchRecordsQuery {
...
const dynamicPhoneNumberBatchCreateRecordsQuery = new DynamicPhoneNumberBatchCreateRecordsQuery();
 ...
 */
export const dynamicPhoneNumberBatchCreateRecords: BatchRecordQuery<PhoneNumber> = async (accessToken: string, phoneNumberRecords: Array<PhoneNumber>): Promise<BatchResults<PhoneNumber>> => {
  return await dynamicPhoneNumberBatchCreateRecordsQuery.runBatch<PhoneNumber>(accessToken, phoneNumberRecords);
};
 ...
 * @return {Promise<BatchResults<PhoneNumber>>}
 */
export const dynamicPhoneNumberBatchUpdateRecords: BatchRecordQuery<PhoneNumber> = async (accessToken: string, phoneNumberRecords: Array<PhoneNumber>): Promise<BatchResults<PhoneNumber>> => {
  return await dynamicPhoneNumberBatchCreateRecordsQuery.runBatch<PhoneNumber>(accessToken, phoneNumberRecords);
};