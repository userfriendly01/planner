...
describe("<SkillGroupInputContainer />", () => {
  ...
  describe("Add button is clicked", () => {
    ...
    test("Name is unique, add button is clicked, but transaction is cancelled", () => {
      renderComponent(tableState);
      const onChange = TextField.mock.calls[0][0].onChange;
    ...
    test.only("Name is unique, skillGroup added successfully with all selected skills", async () => {
    ...
    // test("Name is unique, skillGroup added successfully some skills fail to add to group", () => {});
    // test("Name is unique, skillGroup added successfully all skills fail to add to group", () => {});
    // test("Name is unique, skillGroup failes to add successfully with all selected skills", () => {});
  });
});