...
describe("<ProfileFormFields />", () => {
  ...
  describe("Initial State", () => {
    test("Should render the correct initial state", () => {
      ...
      expectMockedComponent(rendered, { FormControlLabel }, 10);
  ...
  describe("child component interactions", () => {
    test("When switch is toggled, setForm is called", () => {
      renderComponent();
      render(FormControlLabel.mock.calls[0][0].control);  // left five switches
      render(FormControlLabel.mock.calls[5][0].control);  // right five switches
      act(() => {
