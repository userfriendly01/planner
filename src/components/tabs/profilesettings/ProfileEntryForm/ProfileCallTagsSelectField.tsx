...
const ProfileCallTagsSelectField = (props: ProfileCallTagsSelectFieldProps) => {
  ...
  wrkr_tsk_info_id: number
    ...
    console.log("rz newWorkerTaskInfoOptionsChanged() wrkr_tsk_info_id=", wrkr_tsk_info_id);
    console.log("rz newWorkerTaskInfoOptionsChanged() workerTaskInfoOptions=", wrkr_tsk_info_id);
