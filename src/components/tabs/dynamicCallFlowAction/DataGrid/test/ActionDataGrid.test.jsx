...
} from "../../CustomActions/ActionDataGridToolBar";
import {
  DataGrid,
  GridToolbar
...
const renderComponent = () => render(
  <ActionDataGrid accessToken={"Token123"} matchedGroups={[]}/>,
  initialTestState
);
...
describe("<DataGridFlow />", () => {
  ...
  beforeEach(()=>{
    ...
    setupMockedComponents({
      CustomFlowGridToolBar: ActionDataGridToolBar,
      DataGrid,
      GridToolbar,
      PreviewModal
    });
  ...
  describe("Export", ()=>{
    test("Simulate the export", async()=>{
      ...
      renderComponent();
      const exportDataFile = ActionDataGridToolBar.mock.calls[0][0].exportDataFile;
      act(()=>{ exportDataFile(); });
      expect(ActionDataGridToolBar.mock.calls.length).toBe(1);
    });
  });
  ...
  describe("PreviewModal", ()=>{
    ...
    it("Preview Modal onCreate Success", ()=>{
      ...
      renderComponent();
      const openPreviewModal = ActionDataGridToolBar.mock.calls[0][0].openPreviewModal;
