import ClosedMessageSidebar from "../ClosedMessageSidebar";
...
const renderComponent = flashMessageState => {
  return render(<ClosedMessageSidebar
    flashMessageState={flashMessageState}
    setFlashMessageState={mockSetFMState} />);
};

describe("<ClosedMessageSidebar />", () => {
  beforeEach(() => mockSetFMState.mockClear());
  test("the ClosedMessageSidebar should render a radio group for AISG.", () => {
  ...
  test("the ClosedMessageSidebar should render a radio group for CSO.", () => {
