import {
  AddSkillRequestBody, UpdateSkillRequestBody
...
export const addSkillGroup = (requestBody: AddSkillRequestBody): Promise<any> =>
...
export const updateSkillGroup = (skillGroupId: number, requestBody: UpdateSkillRequestBody): Promise<any> =>
