...
export const apiPaths = {
  ...
  CLOSED_MESSAGE: `${ADMIN_CLIENT_URL}/skills/closedmessage`,
  FLASH_MESSAGE: `${ADMIN_CLIENT_URL}/skills/flashmessage`,
  OPERATING_UNITS: `${ADMIN_CLIENT_URL}/skills/operatingunits`,
  SKILL: `${ADMIN_CLIENT_URL}/skills`,
  TASK_QUEUES: `${ADMIN_CLIENT_URL}/skills/taskqueues`,
  TIME_OF_DAYS: `${ADMIN_CLIENT_URL}/skills/timeofdays`,
