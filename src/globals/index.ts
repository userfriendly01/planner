...
export const apiPaths = {
  ...
  GET_CALABRIO_USERS: `${SERVICE_BASE_URI}/calabrio-api/qm/Users`,
  GET_CALABRIO_ORG: `${SERVICE_BASE_URI}/calabrio-api/qm/getOrg`,
  GET_CALABRIO_ROLES: `${SERVICE_BASE_URI}/calabrio-api/qm/Roles`,
  GET_CALABRIO_USER: (personId: number): any => `${SERVICE_BASE_URI}/calabrio-api/qm-user/${personId}`,
