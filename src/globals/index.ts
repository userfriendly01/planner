...
export const apiPaths = {
  ...
  GET_SKILLS_TASKROUTER: `${SERVICE_BASE_URI}/taskrouterskills`,
  GET_SKILLS_CALLFLOW: `${SERVICE_BASE_URI}/callflowskills`,
  GET_SKILLS_CONTACT_MANAGER: `${CONTACT_MANAGER_BASE_URI}/skillswithprofiles`,
