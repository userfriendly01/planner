import { RoutingInitState, RoutingDropDownList, AddPageFieldConfigProps as AddRoutingFieldConfigProps, CctSharedCallRoutingDb } from "../components/tabs/alohaRouting/AlohaRouting.Interfaces";
...
export const routingFields: AddRoutingFieldConfigProps[] = [
    {
        ...
        valueSetter: (currentValue: CctSharedCallRoutingDb, newValue: any) => ({ ...currentValue, ...newValue })
    ...
    },
    {
        ...
        control: "timePicker",
        required: true,
        valueGetter: (params: CctSharedCallRoutingDb, defaultValue: any) => `${params?.startTime ? Date.parse(params.startTime) : defaultValue}`,
        valueSetter: (currentValue: CctSharedCallRoutingDb, newValue: any) => ({ ...currentValue, ...newValue })
    },
    {
        label: "End Time",
        ...
        control: "timePicker",
        required: true,
        valueGetter: (params: CctSharedCallRoutingDb, defaultValue: any) => `${params?.endTime ? Date.parse(params.endTime) : defaultValue}`,
        valueSetter: (currentValue: CctSharedCallRoutingDb, newValue: any) => ({ ...currentValue, ...newValue })
    },
    {
        label: "Policy Type",
...
export const routingInitRule: FormValidationRule = routingFields.reduce((a: FormValidationRule, v: AddRoutingFieldConfigProps) => ({ ...a, [v.key]: { error: false, value: '', required: v.required || false } }), {});
